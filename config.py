...
# Bot related configs
ACTIVE_CHANNELS = [
    1390253494128214077 #kai-testing
]
...
You are currently running {model_name}. Your knowledge cutoff — that is, the latest information you have available — is August 2024.
